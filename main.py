...
def attack(char_name: str, char_class: str) -> str:
    """Расчитывает какой урон наносит герой при атаке."""
...
def defence(char_name: str, char_class: str) -> str:
    """Расчитывает от какого урона защищается герой при обороне."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Показывает какое специальное умение применил герой."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Стартовое меню для тренировки навыков."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выводит меню для выбора имени и типа героя."""
    approve_choice: str = ''
    char_class: str = ''
